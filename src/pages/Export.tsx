...
const Export: React.FC = () => {
  ...
  const renderTemplate = () => {
    switch (selectedTemplate) {
      ...
      case 'minimalist':
        return <MinimalistTemplate forExport={true} />;
      case 'executive':
        return <ExecutiveTemplate forExport={true} />;
      case 'tech':
        return <TechTemplate forExport={true} />;
      case 'academic':
        return <AcademicTemplate forExport={true} />;
      default:
        return <ModernTemplate forExport={true} />;
    }
  };
